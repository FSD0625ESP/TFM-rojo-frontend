    ...
    <Card className="md:m-4">
      <CardContent>
        <div>
          ...
          <p>
            Configuración de cuenta: idioma, notificaciones, seguridad,
            integración con Riot API, cierre de sesión y eliminación de cuenta.
          </p>
          <p>
          ...
          <ul>
            ...
            <li>
              <code>/profile/my-settings/integrations</code>: vinculación con
              Riot, Discord, etc.
            </li>
          </ul>
        </div>
